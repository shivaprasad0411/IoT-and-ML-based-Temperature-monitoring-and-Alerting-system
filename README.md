...
```
- Don't forget to link the bolt wifi module to the bolt cloud and replace your own credentials in the "conf.py" file before executing the python file. 
- Run the following command to monitor the temperature,
```
